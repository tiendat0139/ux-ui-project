  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const res2 = await fetch(
        "http://localhost:3000/tasks?workspace=1&status=In progress"
      );
      const data2 = await res2.json();

      const res3 = await fetch(
        "http://localhost:3000/tasks?workspace=1&status=Resolve"
      );
      const data3 = await res3.json();

      const res4 = await fetch(
        "http://localhost:3000/tasks?workspace=1&status=Close"
      );
